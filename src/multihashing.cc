...
#define DECLARE_CALLBACK(name, hash, output_len) \
 ...
 DECLARE_CALLBACK(allium_hash, 32););
  DECLARE_CALLBACK(blake2s_hash, 32););
  DECLARE_CALLBACK(c11_hash, 32););
  DECLARE_CALLBACK(curve_hash, 32);
  DECLARE_CALLBACK(equi_hash, 32);
  DECLARE_CALLBACK(evrprogpow_hash, 32);
  DECLARE_CALLBACK(firopow_hash, 32);
  DECLARE_CALLBACK(ghostrider_hash, 32);
  DECLARE_CALLBACK(kawpow_hash, 32);
  DECLARE_CALLBACK(meowpow_hash, 32);
  DECLARE_CALLBACK(minotaur_hash, 32);
  DECLARE_CALLBACK(minotaurx_hash, 32);
  DECLARE_CALLBACK(nist5_hash, 32);
  DECLARE_CALLBACK(sha512256d_hash, 32);
  DECLARE_CALLBACK(vert_hash, 32);
  DECLARE_CALLBACK(x16rt_hash, 32);
  DECLARE_CALLBACK(x17_hash, 32);
